									...
									<section>
										...
										<div class="box alt">
											<div class="row gtr-50 gtr-uniform">
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic01.jpg') }}" alt="" /></span></div>
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic02.jpg') }}" alt="" /></span></div>
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic03.jpg') }}" alt="" /></span></div>
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic02.jpg') }}" alt="" /></span></div>
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic03.jpg') }}" alt="" /></span></div>
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic01.jpg') }}" alt="" /></span></div>
												<div class="col-4"><span class="image fit"><img src="{{ asset('/readonly/images/pic03.jpg') }}" alt="" /></span></div>
